...
export const RenkoSnapshotSchema = z.object({
  ...
  sizing_equity: z.number().nullable().optional(),
  open_quantity: z.number().nullable().optional(),
  last_realized_pnl: z.number().nullable().optional(),
  last_brick_close: z.number().nullable().optional(),
